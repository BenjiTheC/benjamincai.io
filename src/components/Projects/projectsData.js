const projectsData = [
    ...
    },
    {
        ...
        desc: "What you are looking at right now. Using latest React and hooks, shit tons of fun building it. Currently it's a pure React front-end and SASS styled website, but I plan to add a back-end for it written in C++.",
        techs: ['React', 'SASS'],
    ...
    },
    {
        ...
        desc: "The website for Division of Benthology and Floodplain Ecology, Institute of Hydrobiology, Chinese Academy of Sciences. My friend's research division (benthology and floodplain ecology) needed a new website and I happened to have a desire to get more familiar with server side rendering web app. The Handlebars is used for HTML template and back-end server is built with ExpressJS.",
